...
// #include "pcl_ros/point_cloud.h"     -> no esta
...
// #include "sensor_msgs/point_cloud2_iterator.h"  ->  no esat

#include "std_msgs/msg/string.hpp"

// #include "my_package/msg/RadarScan.hpp"
...
public:
    ...
    // DataUARTHandler(rclcpp::NodeHandle* nh);
    ...
    // void setNodeHandle(rclcpp::NodeHandle* nh);
...
private:
    ...
    void visualize(const my_package::msg::RadarScan &msg);
    ...
    rclcpp::Publisher<my_package::msg::RadarScan>::SharedPtr radar_scan_pub;
