...
#include "my_package/msg/detail/radar_scan__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const my_package::msg::Header &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  my_package::msg::Header &);
  ...
  size_t current_alignment)
{
  ...
  // Member: header
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        my_package::msg::typesupport_fastrtps_cpp::max_serialized_size_Header(
...
{
  auto typed_message =
    static_cast<const my_package::msg::RadarScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_package::msg::RadarScan *>(
    untyped_ros_message);
...
{
  return &my_package::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
